    ...
    internal class GuardianSurvivor : SurvivorBase
    {
        ...
        internal override void InitializeSkills()
        {
            ...
            SkillDef corePrimarySkillDef = Modules.Skills.CreateSkillDef(new SkillDefInfo
            {
                ...
                activationState = new EntityStates.SerializableEntityStateType(typeof(SkillStates.Primary.TrueStrike)),
            ...
            SkillDef dhPrimarySkillDef = Modules.Skills.CreateSkillDef(new SkillDefInfo
            {
                ...
                activationState = new EntityStates.SerializableEntityStateType(typeof(SkillStates.Primary.PunctureShot)),
                activationStateMachineName = "Weapon",
                baseMaxStock = 1,
                baseRechargeInterval = 0f,
                beginSkillCooldownOnSkillEnd = false,
            ...
            SkillDef fbPrimarySkillDef = Modules.Skills.CreateSkillDef(new SkillDefInfo
            {
                ...
                activationState = new EntityStates.SerializableEntityStateType(typeof(SkillStates.Primary.CoreCleave)),
                activationStateMachineName = "Weapon",
                baseMaxStock = 1,
                baseRechargeInterval = 0f,
                beginSkillCooldownOnSkillEnd = false,
            ...
            SkillDef wbPrimarySkillDef = Modules.Skills.CreateSkillDef(new SkillDefInfo
            {
                ...
                activationState = new EntityStates.SerializableEntityStateType(typeof(SkillStates.Primary.SwordOfWrath)),
                activationStateMachineName = "Weapon",
                baseMaxStock = 1,
                baseRechargeInterval = 0f,
                beginSkillCooldownOnSkillEnd = false,
            ...
            SkillDef dhSecondarySkillDef = Modules.Skills.CreateSkillDef(new SkillDefInfo
            {
                ...
                activationState = new EntityStates.SerializableEntityStateType(typeof(SkillStates.Secondary.TrueShot)),
                activationStateMachineName = "Weapon",
                baseMaxStock = 1,
            ...
            SkillDef fbSecondarySkillDef = Modules.Skills.CreateSkillDef(new SkillDefInfo
            {
                ...
                activationState = new EntityStates.SerializableEntityStateType(typeof(SkillStates.Secondary.SymbolOfVengeance)),
                activationStateMachineName = "Weapon",
                baseMaxStock = 1,
                baseRechargeInterval = 4f,
                beginSkillCooldownOnSkillEnd = true,
            ...
            SkillDef wbSecondarySkillDef = Modules.Skills.CreateSkillDef(new SkillDefInfo
            {
                ...
                activationState = new EntityStates.SerializableEntityStateType(typeof(SkillStates.Secondary.ExecutionersCalling)),
                activationStateMachineName = "Weapon",
                baseMaxStock = 1,
                baseRechargeInterval = 4f,
                beginSkillCooldownOnSkillEnd = true,
            ...
            SkillDef dhUtilitySkillDef = Modules.Skills.CreateSkillDef(new SkillDefInfo
            {
                ...
                activationState = new EntityStates.SerializableEntityStateType(typeof(SkillStates.Utility.TestOfFaithProcessionOfBlades)),
            ...
            SkillDef fbUtilitySkillDef = Modules.Skills.CreateSkillDef(new SkillDefInfo
            {
                ...
                activationState = new EntityStates.SerializableEntityStateType(typeof(SkillStates.Utility.MantraOfSolace)),
                activationStateMachineName = "Slide",
                baseMaxStock = 1,
                baseRechargeInterval = 4f,
                beginSkillCooldownOnSkillEnd = false,
            ...
            SkillDef wbUtilitySkillDef = Modules.Skills.CreateSkillDef(new SkillDefInfo
            {
                ...
                activationState = new EntityStates.SerializableEntityStateType(typeof(SkillStates.Utility.RoilingLight)),
                activationStateMachineName = "Slide",
                baseMaxStock = 1,
                baseRechargeInterval = 4f,
                beginSkillCooldownOnSkillEnd = false,
            ...
            SkillDef coreSpecialSkillDef = Modules.Skills.CreateSkillDef(new SkillDefInfo
            {
                ...
                activationState = new EntityStates.SerializableEntityStateType(typeof(SkillStates.Special.Sanctuary)),
                activationStateMachineName = "Slide",
                baseMaxStock = 1,
            ...
            SkillDef dhSpecialSkillDef = Modules.Skills.CreateSkillDef(new SkillDefInfo
            {
                ...
                activationState = new EntityStates.SerializableEntityStateType(typeof(SkillStates.Special.DragonsMaw)),
                activationStateMachineName = "Slide",
                baseMaxStock = 1,
                baseRechargeInterval = 10f,
                beginSkillCooldownOnSkillEnd = false,
            ...
            SkillDef fbSpecialSkillDef = Modules.Skills.CreateSkillDef(new SkillDefInfo
            {
                ...
                activationState = new EntityStates.SerializableEntityStateType(typeof(SkillStates.Special.MantraOfFlame)),
                activationStateMachineName = "Slide",
                baseMaxStock = 1,
                baseRechargeInterval = 10f,
                beginSkillCooldownOnSkillEnd = false,
            ...
            SkillDef wbSpecialSkillDef = Modules.Skills.CreateSkillDef(new SkillDefInfo
            {
                ...
                activationState = new EntityStates.SerializableEntityStateType(typeof(SkillStates.Special.HeavensPalm)),
                activationStateMachineName = "Slide",
                baseMaxStock = 1,
                baseRechargeInterval = 10f,
                beginSkillCooldownOnSkillEnd = false,
