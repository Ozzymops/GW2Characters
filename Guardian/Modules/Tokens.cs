...
namespace GuardianPlugin.Modules
{
    internal static class Tokens
    {
        internal static void AddTokens()
        {
            ...
            descCore = descCore + "< ! > Gain traits on level up: level 5, level 10 and level 15.\nLevel 5: gain Aegis when struck below 33% health, Aegis shatters for 100% damage on block.\nLevel 10: Virtue of Justice is refreshed when killing a foe.\nLevel 15: all Virtue intervals and cooldowns are reduced by 33%." + Environment.NewLine + Environment.NewLine;
