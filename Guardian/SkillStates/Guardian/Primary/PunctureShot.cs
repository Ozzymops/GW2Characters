...
{
    public class PunctureShot : BaseSkillState
    {
        private bool piercedEnemy;

        public static float damageCoefficient = Modules.StaticValues.dhPrimaryDamage / 100f;
        public static float extraDamage = Modules.StaticValues.dhPrimaryDamageBonus / 100f;
